...
public class ScriptRunner {
    ...
    private void executeFullScript(Reader reader) {
        ...
        try {
            BufferedReader lineReader = createBufferReader(reader);
            String line;
    ...
    private BufferedReader createBufferReader(Reader reader) {
        BufferedReader lineReader;
        if (properties != null && properties.size() > 0) {
            lineReader = new SqlBufferReader(reader, properties);
        } else {
